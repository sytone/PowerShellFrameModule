...
else
{
    ...
    Try
    {
        ...
        Publish-Module @PM
        Write-Host "PowerShellFrame PowerShell Module version $newVersion published to the PowerShell Gallery." -ForegroundColor Cyan
    }
    Catch
    {
        # Sad panda; it broke
    ...
    Try
    {
        ...
        Write-Host "PowerShellFrame PowerShell Module version $newVersion published to GitHub." -ForegroundColor Cyan
    }
    Catch
    {
        # Sad panda; it broke
